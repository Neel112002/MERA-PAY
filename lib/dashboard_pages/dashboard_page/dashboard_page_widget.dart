...
/// I want a card with heading Accured Earnings in top left of card and
/// updated 11 hours ago at top right of the card
              ...
              child: FutureBuilder<List<VerificationsRecord>>(
                future: queryVerificationsRecordOnce(
                  queryBuilder: (verificationsRecord) =>
                    ...
                    isNull:
                        (currentUserUid != '' ? currentUserUid : null) == null,
                  ),
                  singleRecord: true,
                ),
                builder: (context, snapshot) {
                  ...
                  List<VerificationsRecord> listViewVerificationsRecordList =
                      snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final listViewVerificationsRecord =
                      listViewVerificationsRecordList.isNotEmpty
                          ? listViewVerificationsRecordList.first
                          : null;
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            12.0, 0.0, 12.0, 0.0),
                        child: FutureBuilder<List<SelectedBankRecord>>(
                          future: querySelectedBankRecordOnce(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SelectedBankRecord>
                                columnSelectedBankRecordList = snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            ...
                            return SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if ((listViewVerificationsRecord
                                              ?.wizardStep1 ==
                                          false) ||
                                      (listViewVerificationsRecord
                                              ?.wizardstep2 ==
                                          false))
                                    Card(
                                                ...
                                                children: [
                                                  CircularPercentIndicator(
                                                    percent:
                                                      ...
                                                      valueOrDefault<double>(
                                                                functions.getWithdrawablePercentage(
                                                                    listViewVerificationsRecord!
                                                                        .payslipNetSalary),
                                                                0.0,
                                                              ) !=
                                  ...
                                  StreamBuilder<List<SelectedBankRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<SelectedBankRecord>
                                          cardSelectedBankRecordList =
                                          snapshot.data!;
                                      // Return an empty Container when the item does not exist.
                                      if (snapshot.data!.isEmpty) {
                                        return Container();
                                      }
                                      final cardSelectedBankRecord =
                                          cardSelectedBankRecordList.isNotEmpty
                                              ? cardSelectedBankRecordList.first
                                              : null;
