...
import 'employee_information_page_model.dart';
export 'employee_information_page_model.dart';

class EmployeeInformationPageWidget extends StatefulWidget {
  const EmployeeInformationPageWidget({
    super.key,
    this.step2DocRef,
  });
  ...
  static String routeName = 'Employee_InformationPage';
  static String routePath = '/kyc-step-2';

  @override
  State<EmployeeInformationPageWidget> createState() =>
      _EmployeeInformationPageWidgetState();
}

class _EmployeeInformationPageWidgetState
    extends State<EmployeeInformationPageWidget> {
  late EmployeeInformationPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeInformationPageModel());
                                      ...
                                      children: [
                                        Flexible(
                                          child: FlutterFlowRadioButton(
                                            options: [
                                              '0 - 2,99,999.99',
                                              '3,00,000 - 6,99,999.99',
                                              '7,00,000 - 11,99,999.99',
                                              '12,00,000 - 19,99,999.99',
