...
import 'kyc_step2_model.dart';
export 'kyc_step2_model.dart';

class KycStep2Widget extends StatefulWidget {
  const KycStep2Widget({
    super.key,
    this.step2DocRef,
  });

  final DocumentReference? step2DocRef;

  static String routeName = 'Kyc_Step_2';
  static String routePath = '/kyc-step-2';

  @override
  State<KycStep2Widget> createState() => _KycStep2WidgetState();
}

class _KycStep2WidgetState extends State<KycStep2Widget> {
  late KycStep2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KycStep2Model());
                    ...
                    children: [
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: 'Provide Your Company’s Name',
                                  ...
                                  children: [
                                    Flexible(
                                      child: FlutterFlowRadioButton(
                                        ...
                                        radioButtonColor: Color(0xFF22D846),
                      ...
                      Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              FFAppState().KYCwizardStep1 = (_model
                                                  .dropDownValue1 !=
                                              null &&
                                  ...
                                  : false;
                              safeSetState(() {});
                              _model.entryAvailable =
                                  await queryEmployeeInformationRecordOnce(
                              ...
                              if (_model.employeeInfo != null) {
                                context.pushNamed(KycStep3Widget.routeName);
                              } else {
                                if ((_model.dropDownValue1 != null &&
                                    ...
                                    (_model.textController9.text != '') &&
                                    (_model.textController10.text != '')) {
                                  var employeeInformationRecordReference =
                                      EmployeeInformationRecord.collection
                                          .doc(currentUserUid);
                                  await employeeInformationRecordReference
                                      .set(createEmployeeInformationRecordData(
                                    ...
                                    streetAddress: _model.textController8.text,
                                    fathersName: _model.textController9.text,
                                    mothersName: _model.textController10.text,
                                    companyName: _model.textController1.text,
                                    wizardStep1: FFAppState().KYCwizardStep1,
                                    uid: currentUserUid,
                                  ));
                                  _model.employeeInfo = EmployeeInformationRecord
                                      .getDocumentFromData(
                                          createEmployeeInformationRecordData(
                                            organization: _model.dropDownValue1,
                                            annualIncome:
                                                _model.radioButtonValue,
                                            firstName:
                                            ...
                                            wizardStep1:
                                                FFAppState().KYCwizardStep1,
                                            uid: currentUserUid,
                                          ),
                                          employeeInformationRecordReference);

                                  context.pushNamed(
                                    KycStep3Widget.routeName,
                                    queryParameters: {
                                      'docRefspet2': serializeParam(
                                        _model.employeeInfo?.reference,
