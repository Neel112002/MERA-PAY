...
import 'kyc_step3_model.dart';
export 'kyc_step3_model.dart';

class KycStep3Widget extends StatefulWidget {
  const KycStep3Widget({
    super.key,
    this.docRefspet2,
  });
  ...
  static String routeName = 'Kyc_Step_3';
  static String routePath = '/kyc-step-3';

  @override
  State<KycStep3Widget> createState() => _KycStep3WidgetState();
}

class _KycStep3WidgetState extends State<KycStep3Widget> {
  late KycStep3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KycStep3Model());
